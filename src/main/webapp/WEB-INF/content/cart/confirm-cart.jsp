			...
			<div class="cls">
				...
				<div class="main_wrap">
					<ol class="step step-three fr">
						<li class="first"><strong><span><i class="icocart"></i>我的购物车</span></strong></li>
						<li><strong class="current"><span>核对订单信息</span></strong></li>
						<li class="last"><strong><span>订单提交成功</span></strong></li>
					</ol>
					<h1><i class="ico_indicator"></i>确认订单消息</h1>
