    ...
    $.fn.passwordStrength = function(settings) {
        ...
        this.each(function() {
            ...
            $this.bind("keyup blur", function() {
                ...
                pstrength.removeClass().addClass("passwordStrength");
                if (scores < 35 && scores >= 0) {
                    pstrength.addClass("pwdPower_l1");
                } else if (scores < 60 && scores >= 35) {
                    pstrength.addClass("pwdPower_l2");
                } else if (scores >= 60 && scores < 90) {
                    pstrength.addClass("pwdPower_l3");
                } else if (scores >= 90) {
                    pstrength.addClass("pwdPower_l4");
                }
