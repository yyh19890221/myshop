package com.zjut.myshop.web.account;
...
import com.zjut.myshop.dao.HibernateUtils;
...
public class UserAction extends CrudActionSupport<User> {
	...
	protected void prepareModel(Boolean isEdit) throws Exception {
		if(SpringSecurityUtils.getCurrentUser()!=null){
			entity = accountManager.findUserByLoginName(SpringSecurityUtils.getCurrentUserName());
		}
	}
	...
	public void isLogined(){
		if(SpringSecurityUtils.getCurrentUser()== null){
			...
			Struts2Utils.renderText(SpringSecurityUtils.getCurrentUserName());
		}
